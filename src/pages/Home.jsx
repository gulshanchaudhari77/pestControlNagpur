    ...
    <div className="text-white">
      ...
      <section className="flex w-full md:pb-0 pb-[7rem] ">
        ...
        <div className="md:relative bg-gradient-to-r  md:w-[38%] from-green-700 to-green-900">
          <div className="md:w-[20rem] md:h-[12rem] w-[10rem] h-[11rem] bg-yellow-300  absolute left-[1.2rem] bottom-[-1rem] md:bottom-0 md:left-[-4rem]"></div>
          <div className="md:w-[20rem] md:h-[21rem] w-[15rem] h-[8rem] bg-yellow-300  absolute right-5 bottom-[-1rem]  md:bottom-0 md:left-[10rem]"></div>
